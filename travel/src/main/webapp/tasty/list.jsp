...
<body>
	...
	<div class="tastyadd" style="margin-left:1227px;">
		<input type="button" value="맛집추가" onclick="location.href='${pageContext.request.contextPath }/tasty/add.do'" style="color:black; font-family: sans-serif; margin-bottom:10px;">
	</div>
	</c:if>
	
	<div class="tastysearch" style="margin-left:1065px; margin-bottom:10px;">
	...
	<div class="tasty" style="width:1180px; margin:0 auto;">
	<c:forEach var="vo" items="${list }">
	<div class="tastyinfo" style="display:flex; border:1px solid #666; margin-bottom:10px;">
	<div class="tastyimg" style="width:200px; height:125px; overflow:hidden;">
	<img src="${vo.img_path }" style="width:100%; height:100%;">
	</div>
	<div class="tastycont" style="width:100%; margin-left:20px; padding-top:10px;">
		<table>
			<tr style="line-height:2;">
				<th style="width:70px;">맛&nbsp;집&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</th>
				<td><a
					href="${pageContext.request.contextPath }/tasty/detail.do?tasty_num=${vo.tasty_num}">${vo.title }</a></td>
			</tr>
			<tr style="line-height:2;">
				<th style="width:70px;">내&nbsp;용&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</th>
				<td>${vo.content }</td>
			</tr >
			<tr style="line-height:2;">
