                    ...
                    <div class="contact-block">
                        ...
                        <div class="contact-info">
                            <div class=" mb30">
                                ...
                                <div class="mt30">
                                    <h5 class="contact-title">주소 </h5>
                                    <span> 경기도 분당구 성남시 코스타 6층  
               122-365</span></div>
                            </div>
                            <div class=" mb30">
                                <div class="contact-icon"><i class="fa fa-phone"></i></div>
                                <div class="mt30">
                                    <h5 class="contact-title">고객센터 </h5>
                                    <span> 5555-5555 / 
                031-3333-3333</span> </div>
                            </div>
                            <div class="mb30">
                                <div class="contact-icon"><i class="fa fa-envelope"></i></div>
                                <div class="mt30">
                                    <h5 class="contact-title">Email Address</h5>
                                    <span>info@travelstory.com</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class=" col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="row">
                        <form>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button id="singlebutton" name="singlebutton" class="btn btn-primary" onclick="a()">제출하기 </button>
                                </div>
                            </div>
                        </form>
                    </div>
