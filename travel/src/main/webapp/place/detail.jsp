...
const del = () => {
	location.href = "${pageContext.request.contextPath }/place/del.do?place_num=${vo.place_num}&city_num=${sessionScope.city_num}";
}
</script>
</head>
...
<body>
	...
	<div class="placelistall" style="margin-left: 1135px; margin-bottom:10px;">
		<input type="button" value="명소 목록"
			onclick="location.href='${pageContext.request.contextPath }/place/getall.do?city_num=${sessionScope.city_num}'"
			style="color: black; font-family: sans-serif;">
	</div>

	<div class="place" style="width: 1000px; margin: 0 auto;">
		<div class="placeinfo"
			...
			<div class="placecont"
				...
				<form action="${pageContext.request.contextPath }/place/edit.do"
					...
					<table>
						...
						<tr style="line-height: 2;">
							<th style="width: 70px;">명소설명&nbsp;:&nbsp;</th>
							<td><textarea name="content" style="width:400px; margin-top:10px;">${vo.content }</textarea></td>
						</tr>
						<tr style="line-height: 2;">
						...
						<c:if test="${sessionScope.loginId == 'admin' }">
							<div class="placeedit" style="margin-top:40px;">
