...
<body>
	...
	<div class="placeadd" style="margin-left:1227px;">
		<input type="button" value="명소추가" onclick="location.href='${pageContext.request.contextPath }/place/add.do'" style="color:black; font-family: sans-serif; margin-bottom:10px;">
	</div>
	</c:if>
	
	<div class="placesearch" style="margin-left:1065px; margin-bottom:10px;">
	<form
		action="${pageContext.request.contextPath }/place/getbyTitle.do?city_num=${sessionScope.city_num}"
		method="post">
		<input type="text" name="fname"> <input type="hidden"
			name="city_num" value="${sessionScope.city_num }"> <input
			type="submit" value="검색" style="color:black; font-family: sans-serif;">
	</form>
	</div>
	
	
	<div class="place" style="width:1180px; margin:0 auto; padding-bottom:50px;">
	<c:forEach var="vo" items="${list }">
	<div class="placeinfo" style="display:flex; border:1px solid #666; margin-bottom:10px;">
	<div class="placeimg" style="width:200px; height:125px; overflow:hidden;">
	<img src="${vo.img_path }" style="width:100%; height:100%;">
	</div>
	<div class="placecont" style="width:100%; margin-left:20px; padding-top:10px;">
		<table>
			<tr style="line-height:2;">
				<th style="width:70px;">관광지명&nbsp;:&nbsp;</th>
				<td><a
					href="${pageContext.request.contextPath }/place/get.do?place_num=${vo.place_num}">${vo.title }</a></td>
			</tr>
			<tr style="line-height:2;">
