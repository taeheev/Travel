        ...
        <div class="container">
            <div class="row">
                <div class=" col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<input type="button" value="목록으로 돌아가기" onclick="location.href='${pageContext.request.contextPath }/question/listAll.do'" style="color:black; font-family: sans-serif; margin-bottom:10px;">
                    ...
                    <div class="row">
                        <form action ="${pageContext.request.contextPath }/question/add.do" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="file">사진첨부</label>
                                    <input id="file" name="file" type="file" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="content">질문내용</label>
