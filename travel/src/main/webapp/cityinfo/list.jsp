    ...
    <div class="space-medium">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=1">
						<img src="${pageContext.request.contextPath }/Resources/images/london.jpg"
							style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=1" class="destination-title">London</a>
						</h3>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=2"><img
							src="${pageContext.request.contextPath }/Resources/images/paris.jpg"
							style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=2" class="destination-title">Paris</a>
						</h3>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=3">
						<img src="${pageContext.request.contextPath }/Resources/images/barcelona.jpg"
						style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=3" class="destination-title">Barcelona</a>
						</h3>
					</div>
				</div>
				<!-- destination-one-start -->
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=4""><img
							src="${pageContext.request.contextPath }/Resources/images/venice.jpg"
							style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=4" class="destination-title">Venice</a>
						</h3>
					</div>
				</div>
				<!-- destination-one-close -->
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=5"><img
							src="${pageContext.request.contextPath }/Resources/images/rome.jpg"
							style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=5" class="destination-title">Rome</a>
						</h3>
					</div>
				</div>
				<!-- destination-two-close -->
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=6">
						<img src="${pageContext.request.contextPath }/Resources/images/luxembourg.jpg"
						style="width: 360px; height: 300px;"
							alt="사진준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=6" class="destination-title">Luxembourg</a>
						</h3>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=7">
						<img src="${pageContext.request.contextPath }/Resources/images/praha.jpg"
							style="width: 360px; height: 300px;" alt="사진준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=7" class="destination-title">Praha</a>
						</h3>
					</div>
				</div>
				<!-- destination-one-close -->
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="/travel/cityinfo/citymain.do?city_num=8"><img
							src="${pageContext.request.contextPath }/Resources/images/zurich.jpg"
							style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=8" class="destination-title">Zurich</a>
						</h3>
					</div>
				</div>
				<!-- destination-two-close -->
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="destination-img">
						<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=9"><img
							src="${pageContext.request.contextPath }/Resources/images/vienna.jpg"
							style="width: 360px; height: 300px;" alt="사진 준비중!" class="img-responsive"></a>
					</div>
					<div class="destination-content">
						<h3>
							<a href="${pageContext.request.contextPath }/cityinfo/citymain.do?city_num=9" class="destination-title">Vienna</a>
						</h3>
					</div>
				</div>
				<!-- destination-two-close -->
