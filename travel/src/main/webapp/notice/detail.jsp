...
<body>
	...
	<div class="placelistall" style="margin-left: 1135px; margin-bottom:10px;">
		<input type="button" value="목록으로"
			onclick="location.href='${pageContext.request.contextPath }/notice/getall.do'"
			style="color: black; font-family: sans-serif;">
	</div>

	<div class="noticeg" style="width: 1000px; margin: 0 auto;">
		<div class="noticeinfo"
			...
			<div class="noticecont"
				...
				<form action="${pageContext.request.contextPath }/notice/edit.do"
					...
					<table>
						...
						<tr style="line-height: 2;">
							...
							<td><textarea name="content" style="width:400px; height:200px;">${vo.content }</textarea></td>
						</tr>
						<tr style="line-height: 2;">
						...
						<c:if test="${sessionScope.loginId == 'admin' }">
							<div class="noticedit" style="margin-top:40px;">
